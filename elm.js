...
Elm.Main.make = function (_elm) {
   ...
   var EditDomain = function (a) {
      return {ctor: "EditDomain"
             ,_0: a};
   };
         ...
         return function () {
            ...
            {case "_Tuple2":
               switch (_v2._1.ctor)
                 ...
                 break;}
            _U.badCase($moduleName,
            "between lines 210 and 229");
         }();
      }))));
   });
   var queryEntry = function (query) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("query")]),
      _L.fromArray([A2($Html.input,
            ...
            return function () {
                 ...
                 {case "_Tuple2":
                    return function () {
                         ...
                         {case "Just":
                            return A2($Html.div,
                              _L.fromArray([$Html$Attributes.$class("ref-msg")]),
                            ...
                            return function () {
                                 ...
                                 return function () {
                                    ...
                                    {case "Err":
                                       return A2($Html.div,
                                         _L.fromArray([$Html$Attributes.$class("ref-msg")]),
                                         _L.fromArray([$Html.text(_v19._0)]));
                                       case "Ok":
                                       return $Html.div(_L.fromArray([$Html$Attributes.id("stack-hist")]))(A2($Basics.flip,
                                         $List.indexedMap,
   ...
   _L.fromArray([]))]));
   var domEntry = A2($Html.div,
   _L.fromArray([$Html$Attributes.$class("dom")]),
   _L.fromArray([A2($Html.input,
   _L.fromArray([$Html$Attributes.id("dom")
                ,$Html$Attributes.placeholder("4")
                ,A3($Html$Events.on,
                "input",
                $Html$Events.targetValue,
                function ($) {
                   return $Signal.send(updates)(EditDomain($));
                })]),
   _L.fromArray([]))]));
         ...
         {case "AccentFormula":
                    ...
                    return function () {
                       ...
                       {case "_Tuple2":
                          return lf.active ? {ctor: "_Tuple2"
                                             ,_0: A2($Basics._op["++"],
                                             _v31._0,
                                             _L.fromArray([_U.eq(_v31._1,
                                             action._0) ? _U.replace([["highlight"
                                                                      ,action._1]],
                                             lf) : lf]))
                                             ,_1: _v31._1 + 1} : {ctor: "_Tuple2"
                                                                 ,_0: A2($Basics._op["++"],
                                                                 _v31._0,
                                                                 _L.fromArray([lf]))
                                                                 ,_1: _v31._1};}
            ...
            return function () {
                 ...
                 return function () {
                    ...
                    _U.badCase($moduleName,
                    "between lines 144 and 156");
                 }();
              }();
            case "EditDomain":
            return function () {
                 var newDom = function () {
                    var _v41 = $String.toInt(action._0);
                    switch (_v41.ctor)
                    {case "Err":
                       return model.domSize;
                       case "Ok":
                       return _U.cmp(_v41._0,
                         0) > 0 ? _v41._0 : model.domSize;}
                    _U.badCase($moduleName,
                    "between lines 107 and 110");
                 }();
                 return _U.replace([["domSize"
                                    ,newDom]
                                   ,["domBox",action._0]],
                 model);
              }();
            ...
            return function () {
                 var newEnv = function () {
                    var _v44 = $Utils.parseEnv(action._0);
                    switch (_v44.ctor)
                    {case "Err": return model.env;
                       case "Ok": return _v44._0;}
                    _U.badCase($moduleName,
            ...
            return function () {
                 var newInp = function () {
                    var _v47 = $Utils.parseInp(action._0);
                    switch (_v47.ctor)
                    {case "Err":
                       return model.startStack;
                       case "Ok": return _v47._0;}
                    _U.badCase($moduleName,
